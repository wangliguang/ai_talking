...
### 必需硬件
- [x] **主控板**：ESP32-S3-DevKitC-1-N8R8（8MB Flash + 8MB PSRAM，¥30-50）
- [x] **麦克风模块**：INMP441 I2S数字麦克风模块（¥5-10）
- [x] **扬声器模块**：MAX98357A I2S音频功放模块（¥10-15）
- [x] **扬声器单元**：8Ω/1W小型扬声器（¥3-5，MAX98357A模块通常自带）
- [x] **杜邦线**：用于连接I2S模块（¥5）
- [x] **USB线**：USB-C接口，用于编程和供电

**详细选型说明：** 见下方"硬件选型"章节

### 软件服务
- [x] **大模型API**：硅基流动平台（SiliconFlow）- DeepSeek-V3.2 
- [x] **语音识别**：科大讯飞"语音听写"服务（WebSocket实时识别）
- [x] **语音合成**：科大讯飞在线语音合成服务 
